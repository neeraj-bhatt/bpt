...
void generate_output_file(int &min_cover_size, set<int> best_cover){
...
void brute_force_vertex_cover(int n, const vector<pair<int, int>>& edges) {
    ...
    // Output the result
    // cout << "Minimum vertex cover size: " << min_cover_size << endl;
    // cout << "Best vertex cover: ";
    // for (int vertex : best_cover) {
    //     cout << vertex << " ";
    // }
    // cout << endl;
    generate_output_file(min_cover_size, best_cover);
}
